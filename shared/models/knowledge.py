...
# ==================== 知识文档模型 ====================
class KnowledgeDocument(BaseUser):
    """知识文档"""
...
# ==================== 向量搜索模型 ====================
class VectorSearchQuery(BaseUser):
    """向量搜索查询"""
...
class VectorSearchResult(BaseUser):
    """向量搜索结果"""
...
# ==================== 知识图谱模型 ====================
class KnowledgeEntity(BaseUser):
    """知识实体"""
...
class KnowledgeRelation(BaseUser):
    """知识关系"""
...
class DocumentResponse(BaseUser):
    """文档响应"""
    id: UUID
    title: str
